...
4. Open **Windows Settings > Apps > Installed apps > Microsoft Edge WebView2 Runtime > Modify > Repair**. If WebView2 is missing or repairing it does not help, manually download Microsoft's [Evergreen Standalone Installer](https://developer.microsoft.com/en-us/microsoft-edge/webview2/#download-section) for your Windows architecture, run it as administrator, and restart Windows. A WebView2 version folder alone does not confirm that the runtime is completely installed.
